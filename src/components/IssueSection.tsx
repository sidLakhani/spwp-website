...
const stats = [
  {
    icon: School,
    text: "Globally, 2 out of 5 schools (39%) provide menstrual health education.",
  },
  {
    icon: DollarSign,
    text: "1 in 4 students can't afford period products in the US.",
  },
  {
    icon: BookX,
    text: "1 in 5 menstruators miss school because they can't access period products.",
  },
  {
    icon: Bath,
    text: "Over 1 billion menstruators lack access to a safe restroom for managing periods with dignity.",
  },
  {
    icon: HelpCircle,
    text: 'More than half of women don\'t know what a "normal" cycle looks like.',
  },
  {
    icon: Brain,
    text: "Less than two-thirds know how many phases the menstrual cycle has.",
  },
];
